...
from RimMusic import ASSIDS, BOT_ID, MUSIC_BOT_NAME, OWNER_ID, SUDOERS, app
from RimMusic import boottime as bot_start_time
from RimMusic import db, random_assistant
from RimMusic.Core.PyTgCalls import RimMusic
from RimMusic.Database import (add_nonadmin_chat, add_served_chat,
...
from RimMusic.Decorators.admins import ActualAdminCB
from RimMusic.Decorators.permission import PermissionCheck
from RimMusic.Inline import (custommarkup, dashmarkup, setting_markup,
                          setting_markup2, start_pannel, usermarkup, volmarkup)
from RimMusic.Utilities.assistant import get_assistant_details
from RimMusic.Utilities.ping import get_readable_time
...
async def start_markup_check(_, CallbackQuery):
    ...
    if command == "LV":
        ...
        volume = 25
        try:
            await RimMusic.pytgcalls.change_volume_call(c_id, volume)
